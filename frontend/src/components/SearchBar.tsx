  ...
  return (
    ...
    >
      ...
      <div className="flex gap-2 lg:gap-1">
        <button
          type="submit"
          className="md:w-2/4 bg-blue-600 text-white h-full p-2 font-bold text-xl hover:bg-blue-500 rounded-md"
        >
          Search
        </button>
        <button
          type="reset"
          className="md:w-2/4 bg-red-600 text-white h-full p-2 font-bold text-xl hover:bg-red-500 rounded-md"
        >
          Clear
        </button>
      </div>
